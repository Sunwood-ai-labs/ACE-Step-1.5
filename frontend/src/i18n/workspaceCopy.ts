...
export function getWorkspaceCopy(locale: Locale) {
    ...
    return {
      ...
      task: {
        ...
        visualizer: {
          eyebrow: "SNS CUT",
          title: "この曲を、投稿できる映像に。",
          body: "曲名・生成情報・音に同期する波形を整えた、投稿用のローカルMP4を作成します。",
          format: "投稿フォーマット",
          landscape: "横長 · 16:9",
          portrait: "SNS縦長 · 9:16",
          create: "SNSビデオを作成",
          retry: "SNSビデオを作り直す",
          rendering: "SNS用ビデオをレンダリング中…",
          renderingBody: "このまま開いておけば、ここに動画が表示されます。",
          ready: "投稿用ビデオの準備ができました",
          preview: "ビジュアライザ動画を再生",
          download: "ビジュアライザ動画をダウンロード",
          loading: "動画プレビューを準備中…",
          error: "ビジュアライザ動画を読み込めませんでした。",
        },
      },
      service: {
        eyebrow: "ローカルサービス",
      ...
      notice: {
        ...
        visualizerQueued: "ビジュアライザ動画のレンダリングを始めました。",
        visualizerReady: "ビジュアライザ動画を再生できます。",
        visualizerFailed: "ビジュアライザ動画を作成できませんでした。",
      },
    };
  }
  ...
  return {
    ...
    task: {
      ...
      visualizer: {
        eyebrow: "SOCIAL CUT",
        title: "Turn this take into a post-ready video.",
        body: "Create a local MP4 with a title, generation details, and an audio-reactive waveform.",
        format: "Post format",
        landscape: "Landscape · 16:9",
        portrait: "Social vertical · 9:16",
        create: "Create social video",
        retry: "Render social video again",
        rendering: "Rendering social video…",
        renderingBody: "Keep this page open and the video will appear here.",
        ready: "Post-ready video is ready",
        preview: "Play visualizer video",
        download: "Download visualizer video",
        loading: "Preparing video preview…",
        error: "Could not load this visualizer video.",
      },
    },
    service: {
    ...
    notice: {
      ...
      visualizerQueued: "Started rendering the visualizer video.",
      visualizerReady: "Your visualizer video is ready to play.",
      visualizerFailed: "Could not create the visualizer video.",
    },
  };
}
